...
public:
	...
	// Physical Kernel Memory Read Primitive
	BOOL PhysicalRead(IN DWORD64 address, OUT void* buffer, IN size_t bytesToRead);
	// Physical Kernel Memory Write Primitive
	BOOL PhysicalWrite(IN DWORD64 address, IN void* buffer, IN size_t bytesToWrite);
